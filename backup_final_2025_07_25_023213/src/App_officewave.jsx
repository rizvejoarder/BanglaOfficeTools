  ...
  const services = [
    {
      ...
      description: 'Advanced Bengali character recognition with 99.8% accuracy, powered by machine learning algorithms',
      learnMore: '#'
    },
    {
      icon: '📄',
      title: 'Document Conversion',
      description: 'Seamlessly convert between PDF, Word, and image formats while preserving Bengali text formatting',
      learnMore: '#'
    },
    {
      icon: '✨',
      title: 'Text Enhancement',
      description: 'Automatic spell checking and correction for Bengali text with contextual understanding',
      learnMore: '#'
    },
    {
      icon: '📊',
      title: 'Batch Processing',
      description: 'Process multiple documents simultaneously with our powerful cloud-based infrastructure',
      learnMore: '#'
    },
    {
      icon: '📥',
      title: 'Format Preservation',
      description: 'Maintain your document\'s original formatting, layout, and styling during conversion',
      learnMore: '#'
    },
    {
      icon: '🔒',
      title: 'Secure Processing',
      description: 'End-to-end encryption and privacy-focused document processing for sensitive information',
      learnMore: '#'
    }
  ];
  ...
  const features = [
    {
      ...
      title: '99.8% Accuracy',
      description: 'Our advanced OCR algorithms ensure almost perfect recognition of Bengali characters in all documents'
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: 'Lightning Fast',
      description: 'Process documents in seconds with our optimized cloud infrastructure and parallel processing'
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: 'Multiple Dialects',
      description: 'Support for all Bengali dialects and variations, including traditional and modern forms'
    },
    {
      icon: <Database className="w-6 h-6" />,
      title: 'Scalable Storage',
      description: 'Store and manage thousands of documents with our enterprise-grade cloud storage solution'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Team Collaboration',
      description: 'Share documents and collaborate with team members in real-time with version control'
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: 'Enterprise Security',
      description: 'SOC 2 compliant with 256-bit encryption, role-based access control, and audit logs'
    }
  ];
            ...
            {tools.map((tool) => 
              tool.id === selectedTool ? (
                <ToolCard
                  key={tool.id}
                  tool={tool}
                  onFileUpload={(files) => handleFileUpload(files, tool.id)}
